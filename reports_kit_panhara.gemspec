require File.expand_path('../lib/reports_kit_panhara/version', __FILE__)

Gem::Specification.new do |s|
  s.authors       = ['Chhouk Tit Panhara']
  ...
  # s.homepage      = 'https://github.com/tombenner/reports_kit_panhara'

  s.files         = `git ls-files`.split($\)
  s.name          = 'reports_kit_panhara'
  s.require_paths = ['lib']
